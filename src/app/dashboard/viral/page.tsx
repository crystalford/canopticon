        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between pb-6 border-b border-white/5">
                <div>
                    ...
                    <p className="text-slate-400">Real-time trending narratives from the Bluesky network.</p>
                </div>
                <button
                    onClick={fetchFeed}
                    disabled={loading}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {posts.map((post) => (
                    <div key={post.uri} className="glass-panel p-5 flex flex-col h-full group hover:border-orange-500/30 transition-colors">
                        {/* Header */}
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex items-center gap-1 text-[10px] font-mono text-orange-400 bg-orange-500/10 px-2 py-1 rounded">
